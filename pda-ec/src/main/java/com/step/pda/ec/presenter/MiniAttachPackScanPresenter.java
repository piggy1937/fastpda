 ...
 */
public class MiniAttachPackScanPresenter extends IMiniAttachPackScanContract.Presenter  {
    public MiniAttachPackScanPresenter(IMiniAttachPackScanContract.View view, Context context) {
        super(view, context);
    }
